...
export default function PickUp() {
  return (
    <div className="w-11/12 mx-auto rounded-xl mb-60 mt-60 lg:py-12 md:py-8 sm:py-4 lg:px-12 md:px-8 sm:px-2 antialiased">
      <div>
        <div class="flex lg:flex-row md:flex-row sm:flex-col gap-8">
          ...
          <div class="basis-3/5 sm:order-1">
            <h2 className="lg:text-6xl md:text-5xl sm:text-5xl text-black font-extrabold mb-2">
              Pick-up Service
            </h2>
            ...
            <div className="mt-2">
              <h4 className="lg:text-2xl md:text-2xl sm:text-2xl text-blue font-extrabold mb-2 antialiased">
