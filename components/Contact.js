    ...
    <div className="w-11/12 mx-auto rounded-xl bg-bkgGray lg:my-60 md:my-32 sm:my-24 lg:py-12 md:py-8 sm:py-8 lg:px-12 md:px-8 sm:px-4 antialiased">
      <div className="flex lg:flex-row md:flex-row sm:flex-col gap-6">
        <div className="basis-8/12">
          ...
          <h3 className="font-extrabold text-black lg:text-6xl md:text-2xl sm:text-4xl mt-4">
            0214 450 450
          </h3>
          <p className="text-gray font-medium lg:text-2xl md:text-sm">
            info@blueboxstorage.ie
          </p>
          <p className="lg:mt-4 md:mt-2 sm:mt-4 font-bold text-black lg:text-xl md:text-sm">
            Business Hours
          </p>
        ...
        <div className="basis-4/12 lg:mt-0 md:mt-0 sm:mt-8">
          <div>
            <Image
