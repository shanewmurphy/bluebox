...
export default function PickUpTwo() {
  return (
    <div className="w-11/12 mx-auto bg-blue rounded-xl lg:py-16 lg:px-16 md:py-12 md:px-12 sm:px-4 sm:py-6 antialiased">
      <div class="flex lg:flex-row md:flex-row sm:flex-col gap-6">
        <div class="basis-2/5 lg:order-1 md:order-1 sm:order-2">
          <div>
            <Image
        ...
        <div class="basis-3/5 lg:order-2 md:order-2 sm:order-1">
          ...
          <div className="lg:w-8/12 bg-white rounded-md py-4 px-4 mt-2">
